...
define("WEBBOT_NAME", "Mozilla/5.0 (Windows NT 6.3; Trident/7.0; rv:11.0) like Gecko");
...
define("COOKIE_FILE", getcwd().'\cookie.txt');
...
function http($target, $ref, $method, $data_array, $incl_head)
    ...
    # Create return array
    $webpage_text = curl_exec($ch);
    $return_array['TEXT']   = preg_replace("/\s+/", " ", $webpage_text);
    $return_array['FILE']   = $webpage_text;
